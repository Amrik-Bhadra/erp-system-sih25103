...
// Route-to-name mapping for breadcrumbs
const routeNameMap: Record<string, string> = {
  "/student/library": "Library",
  "/student/library/search": "Search Books",
  "/student/library/issued": "Issued Books",
  "/student/library/return": "Return Books",
  "/student/library/fines": "Fines",
  "/student/library/notices": "Library Notices",
};
...
const LibraryLayout = () => {
  ...
  const currentRouteName =
    breadcrumbs[breadcrumbs.length - 1]?.label || "Library";

  // Update page title
  useEffect(() => {
    document.title = `${currentRouteName} | Student Library`;
  }, [currentRouteName]);
